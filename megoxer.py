...
bot = telebot.TeleBot('7284141029:AAEFonOAX5eDIzLJm84QL6ccBV1oV8JC1M8')
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"𝙔𝙊𝙐𝙍 𝘼𝙏𝙏𝘼𝘾𝙆 𝙎𝙏𝘼𝙍𝙏𝙀𝘿 𝙎𝙐𝘾𝘾𝙀𝙎𝙎𝙁𝙐𝙇𝙇𝙔 𝘽𝙔 𝙈𝘼𝙁𝙄𝘼 𝘿𝘿𝙊𝙎 ✅ "
    bot.reply_to(message, response)
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 180:
                ...
                response = f"𝘽𝙂𝙈𝙄 𝘿𝘿𝙊𝙎 𝘼𝙏𝙏𝘼𝘾𝙆 𝙁𝙄𝙉𝙄𝙎𝙃𝙀𝘿 𝘽𝙔 𝙈𝘼𝙁𝙄𝘼 𝘿𝘿𝙊𝙎 🔥"
        else:
...
def welcome_start(message):
    ...
    response = f"🙏🏻 𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙈𝘼𝙁𝙄𝘼 𝘿𝘿𝙊𝙎 𝙃𝙐𝘽 𝘼𝙇𝙇 𝘾𝙊𝙈𝙈𝘼𝙉𝘿 𝘼𝙑𝘼𝙄𝙇𝘼𝘽𝙇𝙀 𝙊𝙉 𝙈𝙀𝙉𝙐. 𝙅𝙊𝙄𝙉 𝙊𝙐𝙍 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 @MCUxZeheR"
    bot.reply_to(message, response)
